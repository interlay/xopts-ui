...
import { CHANGE_SELECTED_PAGE, CHANGE_CURRENCY, CHANGE_CLICKED_OPTION, TOGGLE_MODAL, ADD_MODAL,
    ChangeSelectedPage, ChangeCurrency, ChangeClickedOption, ToggleModal, AddModal } from "../types/actions.types";
...
export const toggleModalAction = (name: string, show: boolean): ToggleModal => ({
    type: TOGGLE_MODAL,
    name,
    show
});
