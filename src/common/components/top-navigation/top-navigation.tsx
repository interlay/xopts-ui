...
export default function TopNavigation(): ReactElement {
    ...
    const isRW = useSelector((state: AppState) => state.lib.isRWConnected);
        ...
        <div className="top-navigation container-fluid">
            ...
            <div className="row">
                <div className="col-xl-5 col-lg-5 col-md-6 col-sm-6 col-10 logo-section">
                    <Link to="/" onClick={openPage("landing")}>
                        <img
                            src={logo}
                            width="30"
                            height="30"
                ...
                <div className="menu col-xl-7 col-lg-7 col-md-6 col-sm-6 col-2">
                    ...
                    <div
                        className={
                            "navigation-items " + (isOpened ? "open" : "")
                        }
                    >
                        ...
                        {hasMetaMask && account && (
                            <div className="dropdown">
                                <button
                                    className="nav-item nav-button dropdown-toggle"
                                    type="button"
                                    id="dropdownMenu"
                        ...
                        {selectedPage !== "all-expirations" && (
                            <Link
                                className={
                                    "nav-item" +
                                    ("developers" === selectedPage
                                        ? " selected-item"
                                        : "")
                                }
                                onClick={openPage("developers")}
                                to="/help"
                            >
                                Developers
                            </Link>
                        ...
                        <Link
                            className={
                                "nav-item only-in-menu" +
                                ("all-expirations" === selectedPage
                                    ? " selected-item"
                                    : "")
                            }
                            to={"/trade-options/" + currency}
